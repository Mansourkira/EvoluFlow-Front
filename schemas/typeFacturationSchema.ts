...
// Type Facturation Schema
export const typeFacturationSchema = z.object({
...
// Add Type Facturation Schema
export const addTypeFacturationSchema = z.object({
  Reference: z.string().min(1, "La référence est obligatoire"),
  Libelle: z.string().min(1, "Le libellé est obligatoire"),
  Sous_Traitance: z.boolean().optional().nullable(),
});

// Update Type Facturation Schema
export const updateTypeFacturationSchema = z.object({
  Reference: z.string().min(1, "La référence est obligatoire"),
...
// Types
export type TypeFacturation = z.infer<typeof typeFacturationSchema>;
export type AddTypeFacturationFormData = z.infer<typeof addTypeFacturationSchema>;
export type UpdateTypeFacturationFormData = z.infer<typeof updateTypeFacturationSchema>;
